...
#define nrn_init _nrn_init__TriggeredIClamp
#define _nrn_initial _nrn_initial__TriggeredIClamp
#define nrn_cur _nrn_cur__TriggeredIClamp
#define _nrn_current _nrn_current__TriggeredIClamp
#define nrn_jacob _nrn_jacob__TriggeredIClamp
#define nrn_state _nrn_state__TriggeredIClamp
#define _net_receive _net_receive__TriggeredIClamp 
...
#define amp _p[1]
#define amp_columnindex 1
#define i _p[2]
#define i_columnindex 2
#define ilocal _p[3]
#define ilocal_columnindex 3
#define v _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 TriggeredIClamp trigstim.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "trigstim.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
