...
if savetracesfile == 1:
    if leak_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_Leak_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if Na_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_Na_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if KLT_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_KLT_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if KHT_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_KHT_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if IH_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_IH_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if KA_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Experiments_KA_Changes\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
    if Sierksma_exp == 1:
        file_path = fr'C:\Users\nikol\PycharmProjects\MNTB_neuron\MNTB_Neuron_images\Sierskma_Values\{filename}'
        fig1.savefig(file_path, dpi=1200, bbox_inches='tight')
if savestimfile == 1:
