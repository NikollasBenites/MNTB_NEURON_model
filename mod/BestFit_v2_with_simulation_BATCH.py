...
exp_file = f"MNTB_Model_Dann/experimental_data_P{age}.csv"
experimental_data = pd.read_csv(exp_file)
...
output_dir = os.path.join(os.getcwd(), "figures", f"BestFit_{age}_{timestamp}")
