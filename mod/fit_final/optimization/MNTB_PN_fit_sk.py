...
class MNTB:
    def __init__(self, gid, somaarea, erev, gleak, ena, gna, gh, gka, gklt, gkht,ek,sk,
                 cam, kam, cbm, kbm):#,
                 # cah, kah, cbh, kbh,
                 # can, kan, cbn, kbn,
                 # cap, kap, cbp, kbp):
    ...
    def _setup_biophysics(self):
        ...
        for seg in self.soma:
            ...
            seg.ena = self.ena
            seg.ek = self.ek
            seg.cai = 0.001  # Constant 1 µM calcium — enough to activate BK
            ...
            seg.sk.gbar = nstomho(self.sk, self.somaarea)
