...
import MNTB_PN_myFunctions_sk as mFun
...
PassiveParams = namedtuple("PassiveParams", ["gleak", "gklt", "gh", "erev", "gkht", "gna", "gka","sk"])
...
def fit_passive(filename):
    ...
    def compute_ess(params):
        gleak, gklt, gh, erev, gkht, gna, gka,sk = params
