...
ratio_fixed = gna_fixed / gklt_fixed if gklt_fixed != 0 else 0.0

# === Define ranges ===
gna_values = np.linspace(20, 400, 30)        # Sodium conductance in nS
ratios = np.linspace(0.05, 20.0, 30)  # gNa / gKLT ratios, avoiding 0 to prevent divide-by-zero    # gNa/gKLT ratios
