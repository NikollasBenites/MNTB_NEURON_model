...
exp_steady_state_voltages = (experimental_data["SteadyStateVoltage"].values)*1e3
...
initial_guess = [20, 100, 25, -70]  # Initial values in the middle of the range
bounds = [(0,40),(0,200),(0, 50), (-80,-60)]  # Set parameter bounds
...
output_dir = os.path.join(os.getcwd(), "figures", f"BestFit_P9_OLD_{timestamp}")
