...
if __name__ == "__main__":
    base_directory = "/Users/nikollas/Library/CloudStorage/OneDrive-UniversityofSouthFlorida/MNTB_neuron/mod/fit_final/results/_last_simulations/iMNTB"  # Change to your actual path
