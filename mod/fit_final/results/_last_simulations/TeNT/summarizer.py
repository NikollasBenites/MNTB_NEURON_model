        ...
        for file in files:
            if file == "simulation_meta.txt":
                ...
                try:
                    ...
                    # Infer group from folder name or file path
                    if "imntb" in folder_name.lower():
                        meta["group"] = "iMNTB"
                    elif "tent" in folder_name.lower():
                        meta["group"] = "TeNT"
                    else:
                        meta["group"] = "Unknown"
...
if __name__ == "__main__":
    base_directory = "/Users/nikollas/Library/CloudStorage/OneDrive-UniversityofSouthFlorida/MNTB_neuron/mod/fit_final/results/_last_simulations/TeNT"  # Change to your actual path
    summary_df = gather_simulation_summaries(base_directory)
    summary_df.to_csv("simulation_summary_cleaned_TeNT.csv", index=False)
