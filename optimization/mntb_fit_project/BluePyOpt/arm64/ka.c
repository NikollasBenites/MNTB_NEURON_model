...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 ka /Users/nikollas/Library/CloudStorage/OneDrive-UniversityofSouthFlorida/MNTB_neuron/optimization/mntb_fit_project/BluePyOpt/mod/ka.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/nikollas/Library/CloudStorage/OneDrive-UniversityofSouthFlorida/MNTB_neuron/optimization/mntb_fit_project/BluePyOpt/mod/ka.mod";
static const char* nmodl_file_text = 
  ...
  "PARAMETER {\n"
  "        v (mV)\n"
  "        celsius = 35 (degC)  : model is defined on measurements made at room temp in Baltimore\n"
  "        dt (ms)\n"
  "        ek = -77 (mV)\n"
